...
async def toggle_stars(call: CallbackQuery):
    ...
    status_text = "yoqildi ✅" if new == "1" else "o'chirildi ❌"
    await call.answer(f"Stars {status_text}", show_alert=True)
    await call.message.delete()
...
async def toggle_premium(call: CallbackQuery):
    ...
    status_text = "yoqildi ✅" if new == "1" else "o'chirildi ❌"
    await call.answer(f"Premium {status_text}", show_alert=True)
    await call.message.delete()
